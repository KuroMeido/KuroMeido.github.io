...
window.siteData.blogPosts = [
    {
        category: "Revit API",
        title: "The Revit API Roadmap — For Absolute Beginners",
        description: "A six-stage learning path from zero coding background to building Revit add-ins.",
        image: "assets/images/pyRevit.png",
        url: "posts/revit-api-roadmap-beginners.html"
    },
    {
        category: "Revit API",
